...
type cUsersJacobodevMainPersonalgatsbyBootcampsrctemplatesBlogTsx3210822286QueryVariables = Exact<{
  slug: Scalars['String'];
}>;


type cUsersJacobodevMainPersonalgatsbyBootcampsrctemplatesBlogTsx3210822286Query = { readonly markdownRemark: Maybe<(
...
type Unnamed_1_Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'author'>> }> };
